...
def test_load_csvs_concatenates(tmp_path):
    ...
    p1 = d / "a.csv"
    p2 = d / "b.csv"
    p1.write_text("Date,Amount (EUR),Name / Description,Counterparty,Debit/credit,Account\n20260101,1234,Party A,IBAN1,Credit,ACC1\n")
    p2.write_text("Date,Amount (EUR),Name / Description,Counterparty,Debit/credit,Account\n20260201,567,Party B,IBAN2,Debit,ACC1\n")
...
def test_clean_transactions_ing_parses_amounts_and_dates(raw_transactions):
    df = raw_transactions
